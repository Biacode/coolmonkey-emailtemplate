 ...
 * Time: 8:23 PM
 */
public class GetEmailGridRequest extends AbstractCompanyUuidAwareRequestModel {
    ...
    //region Constructors
    public GetEmailGridRequest() {
    }

    public GetEmailGridRequest(final String companyUuid) {
        super(companyUuid);
    }
    //endregion
