 ...
 * Time: 8:32 PM
 */
public class EmailTemplateModel implements ApiModel {
    private static final long serialVersionUID = 5171517166692342944L;
    ...
    public EmailTemplateModel(final String uuid, final EmailTemplateTypeModel type, final String name, final String senderName, final String senderEmail, final String replyEmail, final List<String> ccEmails, final List<String> bccEmails, final String subject, final String htmlContent, final List<AttachmentModel> attachments, final boolean active) {
        this.uuid = uuid;
        this.type = type;
        this.name = name;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof EmailTemplateModel)) {
            return false;
        }
        final EmailTemplateModel that = (EmailTemplateModel) o;
