package com.sfl.coolmonkey.emailtemplate.api.rest.resources.aspect;
...
public class ResourceMethodLoggingAspect {
    ...
    @Around("execution(public * com.sfl.coolmonkey.emailtemplate.api.rest.resources..* (..))")
    ...
    @AfterThrowing(value = "execution(public * com.sfl.coolmonkey.emailtemplate.api.rest.resources..* (..))",
            throwing = "e")
