package com.sfl.coolmonkey.emailtemplate.facade.aspect;
...
public class FacadeMethodLoggingAspect {
    ...
    @Around("execution(public * com.sfl.coolmonkey.emailtemplate.facade..* (..))" +
            " && !execution(* com.sfl.coolmonkey.emailtemplate.facade.helper..* (..))")
